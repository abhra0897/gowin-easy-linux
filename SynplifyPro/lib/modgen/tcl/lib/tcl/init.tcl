...
# Ignoring -exact to allow Tcl 8.5 for Windows 64-bit
...
# -*- tcl -*-
# Copyright (C) 2001 ActiveState Corporation Nov 24, 2003
#
# Extension code to tcl8.4/library/init.tcl declaring the
# version information for ActiveTcl.
#
# ActiveState ActiveTcl 8.4.5.0 Win32/x86, Mon Nov 24 12:48:10 PM Pacific Standard Time 2003
#
...
namespace eval ::activestate {
	...
	maturity      {final}
	arch          {win32-ix86}
	buildtime,sec {1069706890}
	buildtime,fmt {Mon Nov 24 12:48:10 PM Pacific Standard Time 2003}
	as,mode       {normal}
    }
    ...
    variable  config
    array set config {
	{ActiveTcl} {ActiveState ActiveTcl 8.4.5.0 Win32/x86, Build @buildno@ @ Mon Nov 24 12:48:10 PM Pacific Standard Time 2003 / normal}
    }
}
