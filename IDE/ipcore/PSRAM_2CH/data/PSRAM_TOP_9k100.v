...
input                   rst_n;
output                  clk_out;
output  [3:0]           O_psram_ck;
output  [3:0]           O_psram_ck_n;
inout   [3:0]           IO_psram_rwds;
inout   [31:0]          IO_psram_dq;
output  [3:0]           O_psram_reset_n;
output  [3:0]           O_psram_cs_n;
output                  init_calib0;
output                  init_calib1;
input   [63:0]          wr_data0/* synthesis syn_keep=1 */;
output  [63:0]          rd_data0/* synthesis syn_keep=1 */;
output                  rd_data_valid0/* synthesis syn_keep=1 */;
output                  rd_data_valid1/* synthesis syn_keep=1 */;
input   [63:0]          wr_data1/* synthesis syn_keep=1 */;
output  [63:0]          rd_data1/* synthesis syn_keep=1 */;
input                   cmd0;
input                   cmd_en0;
input   [20:0]          addr0;
input   [7:0]           data_mask0;
input                   cmd1;
input                   cmd_en1;
input   [20:0]          addr1;
input   [7:0]           data_mask1;
...
`getname(psram_memory_interface,`module_name_psram) u_psram_top0  (
            .clk        (clk),
            .clk_x2     (clk_x2),
            .clk_x1     (clk_x1),
            .ready      (ready),
...
`getname(psram_memory_interface,`module_name_psram)  u_psram_top1 (
            .clk        (clk),                    
            .clk_x2     (clk_x2),
            .clk_x1     (clk_x1),
            .ready      (ready),
            ...
            .dll_step   (dll_step),
            .rst_n      (rst_n),  
            .O_psram_ck (O_psram_ck[3:2]),
            .O_psram_ck_n(O_psram_ck_n[3:2]),
            .IO_psram_rwds(IO_psram_rwds[3:2]),
            .IO_psram_dq(IO_psram_dq[31:16]),
            .O_psram_reset_n(O_psram_reset_n[3:2]),
            .O_psram_cs_n(O_psram_cs_n[3:2]),
            .wr_data    (wr_data1),
            .rd_data    (rd_data1),
